...
<div id="Menu" class="clearfix">
    <div class="index_style clearfix">
        <div id="allSortOuterbox">
            ...
            <div class="Category"><a href="#"><em></em>修改商品</a></div>
...
<div class="right_style">
    ...
    <div class="frame user_address clearfix">
        <form  action="${pageContext.request.contextPath}/ChangeProductServlet?user=${user}" method="post" >
            <div class="Add_Addresss">
                <div class="title_name"><i></i>修改商品</div>
                <table>
                ...
                <div class="btn"><input name="1" type="submit" value="修改商品" class="Add_btn" /></div>
