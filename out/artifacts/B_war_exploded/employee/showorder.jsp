...
<div id="header "  class="header page_style">
    ...
    <div class="Search">
        <form action="${pageContext.request.contextPath}/ShowOrderServlet?user=${user}" method="post">
...
<div id="Menu" class="clearfix">
    <div class="index_style clearfix">
        <div id="allSortOuterbox">
            ...
            <div class="Category"><a href="#"><em></em>查看购买记录</a></div>
...
<div class="Inside_pages">
    <div class="content mar_20">
        <table border="0" class="car_tab" style="width:1200px; margin-bottom:50px;" cellspacing="0" cellpadding="0">
            ...
            <td class="car_th" width="150">数量</td>
            <td class="car_th" width="150">价格</td>
            <td class="car_th" width="300">时间</td>
            <c:forEach items="${order}" var="o">
                <tr>
                    <td align="center" style="color:#ff4e00;">${o.o_pname}</td>
                    <td align="center" style="color:#ff4e00;">${o.o_ptype}</td>
                    <td align="center" style="color:#ff4e00;">${o.onum}</td>
                    <td align="center" style="color:#ff4e00;">${o.oprice}</td>
                    <td align="center" style="color:#ff4e00;">${o.otime}</td>
                </tr>
            </c:forEach>
            </tbody>
        </table>
