...
<%
    ...
    try {
        ps = dao.listonetype(user.getUtype());
...
<div class="right_style">
    <div class="frame user_address clearfix">
        <div class="Add_Addresss">
            <div class="title_name"><i></i>商品近7天销量</div>
            <form action="${pageContext.request.contextPath}/LinesalesServlet?user=${user}" method="post">
            <table>

                <tr>
                    <td class="label_name">商品名称</td><td><input name="productname" type="text"  class="Add-text"/><i>（必填）</i></td>
