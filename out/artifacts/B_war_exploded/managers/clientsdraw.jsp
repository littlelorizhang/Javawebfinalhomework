...
<div id="Menu" class="clearfix">
    <div class="index_style clearfix">
        <div id="allSortOuterbox">
            ...
            <div class="Category"><a href="#"><em></em>用户画像</a></div>
...
<div class="right_style">
    <div class="frame user_address clearfix">
        <div class="Add_Addresss">
            <div class="title_name"><i></i>用户画像</div>
            <form action="${pageContext.request.contextPath}/ClientDrawServlet?user=${user}" method="post">
                <table>
...
<div class="right_style">
    <div class="frame user_address clearfix">
        <div class="Add_Addresss">
            <div class="title_name"><i></i>用户画像信息</div>
            <table>

                <tr>
                    <td class="label_name">用户地域：${diyu}</td>
                    <td class="label_name">用户购买力：${goumaili}</td>
                    <td class="label_name">用户偏好类别：${pianhao}</td>
