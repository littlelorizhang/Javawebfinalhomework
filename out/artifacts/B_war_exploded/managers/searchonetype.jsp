...
<div id="Menu" class="clearfix">
    <div class="index_style clearfix">
        <div id="allSortOuterbox">
            ...
            <div class="Category"><a href="#"><em></em>查看某类商品销量</a></div>
...
<div class="right_style">
    ...
    <div class="frame user_address clearfix">
        <form  action="${pageContext.request.contextPath}/SearchonetypeServlet?user=${user}" method="post" >
            <div class="Add_Addresss">
                <div class="title_name"><i></i>查看某类商品销量</div>
                <table>

                    <tr>
                        <td class="label_name">商品类别</td><td><input name="ptype" type="text" value="" id="ptype" class="Add-text"/><i>（必填）</i></td>
                    </tr>


                </table>

                <div class="btn"><input name="1" type="submit" value="查询" class="Add_btn" /></div>
